 ...
 * Use the [GetStartFragment.newInstance] factory method to
...
class GetStartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (isUserLoggedIn()) {
            ...
            (view.context as LoginRegisterActivity).finish()
        } else {
            ...
            view.findViewById<MaterialButton>(R.id.btn_get_started).setOnClickListener {
                it.isEnabled = false
//                startActivity(Intent(view.context, LoginRegisterActivity::class.java))
                it.isEnabled = true
            }
        }
        return view
...
//         * @return A new instance of fragment GetStartFragment.
//         */
//         TODO: Rename and change types and number of parameters
//        @JvmStatic
//        fun newInstance(param1: String, param2: String) =
//            GetStartFragment().apply {
...
//            }
        @JvmStatic
        fun newInstance() = GetStartFragment()
    }
}